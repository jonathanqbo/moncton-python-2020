...
def show_win_win(the_win):
    the_win.shapesize(5)
    the_win.circle(5)
    the_win.pensize(50)
    the_win.write('win win')

def show_lose_lose(the_lose):
    the_lose.shapesize(5)
    the_lose.circle(5)
    the_lose.pensize(50)
    the_lose.write('lose lose')
...
while used_chances < 6:
        show_lose_lose(indicator_turtle)
