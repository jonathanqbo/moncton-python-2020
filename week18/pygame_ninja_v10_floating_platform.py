...
class FloatTile(pygame.sprite.Sprite):
    ...
    def __init__(self, game, left, bottom, length, *groups):
        ...
        self.game = game
        self.image = self.__build(length)
        self.rect = self.image.get_rect()
        self.rect.left = left
...
class Game:
    ...
    def build_game(self):
        ...
        GrassPlatform(self, SCREEN_HEIGHT, 3, 1, self.platforms)
        Water(self, SCREEN_HEIGHT, 3, 1, self.decorators)
        GrassPlatform(self, SCREEN_HEIGHT, 3, 1, self.platforms)
        Water(self, SCREEN_HEIGHT, 3, 1, self.decorators)
        GrassPlatform(self, SCREEN_HEIGHT, 3, 1, self.platforms)
        ...
        for i in range(7):
            GrassFloatPlatform(self, water.rect.left + i * 450, 600 - i * 50, 2, self.platforms)
