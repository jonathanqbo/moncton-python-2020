...
def on_btn1_click():
    words1, words2 = get_words_set()
    same_words = words1 & words2
    show_result(same_words)
...
frame_button = tk.Frame(window, background='SlateGray2')
frame_button.pack(side=tk.TOP, pady=20)

button_same_words = tk.Button(frame_button, text='same words', width=20, height=2, background='SlateGray4')
button_same_words['command'] = on_btn1_click
button_same_words.pack(side=tk.LEFT, pady=20, padx=5)

button_left_only_words = tk.Button(frame_button, text='left only words', width=20, height=2, background='SlateGray4')
button_left_only_words['command'] = on_btn2_click
button_left_only_words.pack(side=tk.LEFT, pady=20, padx=5)

button_all_words = tk.Button(frame_button, text='all words', width=20, height=2, background='SlateGray4')
button_all_words['command'] = on_btn3_click
button_all_words.pack(side=tk.LEFT, pady=20, padx=5)

button_not_same_words = tk.Button(frame_button, text='not same words', width=20, height=2, background='SlateGray4')
button_not_same_words['command'] = on_btn4_click
button_not_same_words.pack(side=tk.LEFT, pady=20, padx=5)
